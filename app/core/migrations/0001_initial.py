# Generated by Django 3.0.6 on 2021-02-16 10:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='archived_playertasks', to='core.ArchivedPlayer')),
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='archived_playertasks', to='core.Task')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='archivedplayer',
            name='color',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='archived_players', to='core.Color'),
        ),
        migrations.AddField(
            model_name='archivedplayer',
            name='room',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='archived_players', to='core.ArchivedRoom'),
        ),
        migrations.AddField(
            model_name='archivedplayer',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='archived_players', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
